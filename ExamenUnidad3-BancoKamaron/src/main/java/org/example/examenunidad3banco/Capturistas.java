...
public class Capturistas implements Initializable {
    ...
    public Capturistas(String nombre, String apellido, String fechaNacimiento, String ciudad, EstadosMX estado, String RFC, String CURP, String direccion, String fechaRegistro, String salario, RolesEmpleados rolEmpleado, String fechaInicioTrabajo, Sucursales sucursalPerteneciente, String contrasena) {
        this.nombre = nombre;
