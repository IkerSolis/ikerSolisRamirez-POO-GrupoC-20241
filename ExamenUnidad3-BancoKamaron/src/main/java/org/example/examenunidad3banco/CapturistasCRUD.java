...
public class CapturistasCRUD implements Initializable {
    ...
    @FXML private ListView<Capturistas> listaCapturistasEmpleados;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        listaCapturistasEmpleados.setItems(GerenteMaderoCRUD.empleadosCapturistas);

        listaCapturistasEmpleados.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Capturistas>() { //Crear una especie de instancia que hereda ChangeListener para poder redefinir los métodos abstractos
            @Override
            public void changed(ObservableValue<? extends Capturistas> observableValue, Capturistas capturistaAnterios, Capturistas capturistaSeleccionado) {
    ...
    public void guardarBoton(ActionEvent event) throws IOException {
        ...
        Object evtCapturistasCRUDMadero = event.getSource();
        ...
        if (evtCapturistasCRUDMadero.equals(btnGuardar)) {
            if (txtCapturistaNombre.getText().isEmpty() || txtCapturistaApellidos.getText().isEmpty() || datePickerCapturistaFechaNacimiento.getValue().toString().isEmpty() || txtCapturistaCiudad.getText().isEmpty() || selectedItemComboCapturistasEstadosMX.toString().isEmpty() || txtCapturistaCURP.getText().isEmpty() || txtCapturistaDirección.getText().isEmpty() || datePickerCapturistaFechaRegistro.getValue().toString().isEmpty() || txtCapturistaSalario.getText().isEmpty() || selectedItemComboCapturistasRolesEmpleados.toString().isEmpty() || datePickerCapturistaFechaInicioTrabajo.getValue().toString().isEmpty() || txtCapturistaSalario.getText().isEmpty() || selectedItemComboCapturistasSucursales.toString().isEmpty()) {
                ...
                GerenteMaderoCRUD.empleadosCapturistas.add(
                        new Capturistas(txtCapturistaNombre.getText(),
    ...
    public void actualizarBoton(){
        generarRFC();
        System.out.println("Capturista: " + txtCapturistaNombre.getText() + " guardado.");
        GerenteMaderoCRUD.empleadosCapturistas.set(
    ...
    public void eliminarBoton(){
        ...
        GerenteMaderoCRUD.empleadosCapturistas.remove(listaCapturistasEmpleados.getSelectionModel().getSelectedIndex());
