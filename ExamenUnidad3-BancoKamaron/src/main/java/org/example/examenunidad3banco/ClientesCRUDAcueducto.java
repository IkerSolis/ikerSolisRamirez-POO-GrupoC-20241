...
public class ClientesCRUDAcueducto implements Initializable {
    ...
    @FXML private ListView<ClientesAcueducto> listaClientes;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        listaClientes.setItems(GerenteAcueductoCRUD.clientesAcueducto);

        listaClientes.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<ClientesAcueducto>() { //Crear una especie de instancia que hereda ChangeListener para poder redefinir los métodos abstractos
            @Override
            public void changed(ObservableValue<? extends ClientesAcueducto> observableValue, ClientesAcueducto clienteAnterior, ClientesAcueducto clienteSeleccionado) {
    ...
    public void guardarBoton(ActionEvent event) throws IOException {
        ...
        Object evtClientesCRUDAcueducto = event.getSource();
        ...
        if (evtClientesCRUDAcueducto.equals(btnGuardar)) {
            if (txtClienteNombre.getText().isEmpty() || txtClienteApellidos.getText().isEmpty() || datePickerClienteFechaNacimiento.getValue() == null || txtClienteCiudad.getText().isEmpty() || selectedItemComboClientesEstadosMX == null || selectedItemComboClientesEstadosMX.toString().isEmpty() || txtClienteCURP.getText().isEmpty() || txtClienteDirección.getText().isEmpty() || datePickerClienteFechaRegistro.getValue() == null || datePickerClienteFechaRegistro.getValue().toString().isEmpty() || selectedItemComboClientesSucursales == null || selectedItemComboClientesSucursales.toString().isEmpty() || txtClienteContrasena.getText().isEmpty()) {
                ...
                ClientesAcueducto nuevoCliente = new ClientesAcueducto(
                ...
                GerenteAcueductoCRUD.clientesAcueducto.add(nuevoCliente);
    ...
    public ClientesAcueducto obtenerClienteSeleccionado() {
    ...
    public void actualizarBoton(){
        ...
        GerenteAcueductoCRUD.clientesAcueducto.set(
                listaClientes.getSelectionModel().getSelectedIndex(), //Para obtener el objeto seleccionado
                new ClientesAcueducto(txtClienteNombre.getText(),
                        txtClienteApellidos.getText(),
                        datePickerClienteFechaNacimiento.getValue().toString(),
                        txtClienteCiudad.getText(),
                        comboClienteEstadosMX.getSelectionModel().getSelectedItem(),
    ...
    public void eliminarBoton(){
        ...
        GerenteAcueductoCRUD.clientesAcueducto.remove(listaClientes.getSelectionModel().getSelectedIndex());
    ...
    private void cambiarVerTarjetasClientes(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("VerTarjetasClientesAcueducto.fxml"));
        stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
