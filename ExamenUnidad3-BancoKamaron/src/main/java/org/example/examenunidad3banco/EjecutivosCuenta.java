...
public class EjecutivosCuenta implements Initializable {
    ...
    public EjecutivosCuenta(String nombre, String apellido, String fechaNacimiento, String ciudad, EstadosMX estado, String RFC, String CURP, String direccion, String fechaRegistro, String salario, RolesEmpleados rolEmpleado, String fechaInicioTrabajo, Sucursales sucursalPerteneciente, String contrasena) {
        this.nombre = nombre;
