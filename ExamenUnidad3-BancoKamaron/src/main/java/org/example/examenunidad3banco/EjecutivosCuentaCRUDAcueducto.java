...
public class EjecutivosCuentaCRUDAcueducto implements Initializable {
    ...
    @FXML private ListView<EjecutivosCuentaAcueducto> listaEjecutivosCuentaEmpleados;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        listaEjecutivosCuentaEmpleados.setItems(GerenteAcueductoCRUD.empleadosEjecutivosCuentaAcueducto);

        listaEjecutivosCuentaEmpleados.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<EjecutivosCuentaAcueducto>() { //Crear una especie de instancia que hereda ChangeListener para poder redefinir los métodos abstractos
            @Override
            public void changed(ObservableValue<? extends EjecutivosCuentaAcueducto> observableValue, EjecutivosCuentaAcueducto ejecutivoCuentaAnterios, EjecutivosCuentaAcueducto ejecutivoCuentaSeleccionado) {
    ...
    public void guardarBoton(ActionEvent event) throws IOException {
        ...
        Object evtEjecutivosCuentaCRUDAcueducto = event.getSource();
        ...
        if (evtEjecutivosCuentaCRUDAcueducto.equals(btnGuardar)) {
            if (txtEjecutivosCuentaNombre.getText().isEmpty() || txtEjecutivosCuentaApellidos.getText().isEmpty() || datePickerEjecutivosCuentaFechaNacimiento.getValue().toString().isEmpty() || txtEjecutivosCuentaCiudad.getText().isEmpty() || selectedItemComboEjecutivosCuentaEstadosMX.toString().isEmpty() || txtEjecutivosCuentaCURP.getText().isEmpty() || txtEjecutivosCuentaDirección.getText().isEmpty() || datePickerEjecutivosCuentaFechaRegistro.getValue().toString().isEmpty() || txtEjecutivosCuentaSalario.getText().isEmpty() || selectedItemComboEjecutivosCuentaRolesEmpleados.toString().isEmpty() || datePickerEjecutivosCuentaFechaInicioTrabajo.getValue().toString().isEmpty() || txtEjecutivosCuentaSalario.getText().isEmpty() || selectedItemComboEjecutivosCuentaSucursales.toString().isEmpty()) {
                ...
                GerenteAcueductoCRUD.empleadosEjecutivosCuentaAcueducto.add(
                        new EjecutivosCuentaAcueducto(txtEjecutivosCuentaNombre.getText(),
    ...
    public void actualizarBoton(){
        ...
        GerenteAcueductoCRUD.empleadosEjecutivosCuentaAcueducto.set(
    ...
    public void eliminarBoton(){
        ...
        GerenteAcueductoCRUD.empleadosEjecutivosCuentaAcueducto.remove(listaEjecutivosCuentaEmpleados.getSelectionModel().getSelectedIndex());
    ...
    private void cambiarClientesCRUD(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("ClientesCRUDAcueducto.fxml"));
        stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
