...
public class Inversionistas implements Initializable {
    ...
    public Inversionistas(String nombre, String apellido, String fechaNacimiento, String ciudad, EstadosMX estado, String RFC, String CURP, String direccion, String fechaRegistro, String salario, RolesEmpleados rolEmpleado, String fechaInicioTrabajo, Sucursales sucursalPerteneciente, String contrasena, String dineroInvertido) {
        this.nombre = nombre;
