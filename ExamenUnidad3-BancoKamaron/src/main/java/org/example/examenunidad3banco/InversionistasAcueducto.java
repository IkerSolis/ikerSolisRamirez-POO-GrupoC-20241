...
public class InversionistasAcueducto implements Initializable {
    ...
    public String dineroInvertido;

    public InversionistasAcueducto(String nombre, String apellido, String fechaNacimiento, String ciudad, EstadosMX estado, String RFC, String CURP, String direccion, String fechaRegistro, String salario, RolesEmpleados rolEmpleado, String fechaInicioTrabajo, Sucursales sucursalPerteneciente, String contrasena, String dineroInvertido) {
        this.nombre = nombre;
    ...
    public String getDineroInvertido() {
        return dineroInvertido;
    }

    public void setDineroInvertido(String dineroInvertido) {
        this.dineroInvertido = dineroInvertido;
    }
