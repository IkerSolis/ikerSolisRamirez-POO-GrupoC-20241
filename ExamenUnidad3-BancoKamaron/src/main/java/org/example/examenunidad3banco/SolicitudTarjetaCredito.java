...
public class SolicitudTarjetaCredito implements Initializable {
    ...
    @FXML
    private ListView<SolicitudTarjetaCredito> listaSolicitudesTC;
    ...
    public SolicitudTarjetaCredito(Clientes usuario, TipoTarjetaCredito simplicity, EstadoTarjetaCredito enEspera) {
        // Este constructor está vacío por ahora
    }

    public SolicitudTarjetaCredito(Clientes usuario, TipoTarjetaCredito tipoTarjetaSolicitada, double saldo, EstadoTarjetaCredito estadoTarjetaCredito) {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        listaSolicitudesTC.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<SolicitudTarjetaCredito>() {
            @Override
            public void changed(ObservableValue<? extends SolicitudTarjetaCredito> observableValue, SolicitudTarjetaCredito solicitudAnterior, SolicitudTarjetaCredito solicitudSeleccionada) {
    ...
    private void aceptarSolicitud(ActionEvent event) throws IOException {
        SolicitudTarjetaCredito solicitudSeleccionada = listaSolicitudesTC.getSelectionModel().getSelectedItem();
