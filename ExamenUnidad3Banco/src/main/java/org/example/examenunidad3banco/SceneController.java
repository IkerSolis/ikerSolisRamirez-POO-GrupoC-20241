...
public class SceneController implements Initializable {
    ...
    @FXML private PasswordField passwordContraseñaInversionistaMadero;
    ...
    private void SelecUsuariosInversionistaMadero(ActionEvent event) throws IOException {
        ...
        if (evtInversionistaMaderoInicioSesion.equals(btnInicioSesionInversionistaMadero)) {
            if (!txtUsuarioInversionistaMadero.getText().isEmpty() && !passwordContraseñaInversionistaMadero.getText().isEmpty()) {
                String nombreUsuario = txtUsuarioInversionistaMadero.getText();
                String contraseñaUsuario = passwordContraseñaInversionistaMadero.getText();
    ...
    private void eventKey(KeyEvent event) {
        ...
        } else if (evtInversionistaMaderoInicioSesion.equals(passwordContraseñaInversionistaMadero)) {
            if (evtInversionistaMaderoInicioSesion.equals(txtUsuarioInversionistaMadero)) {
                if (event.getCharacter().equals(" ")) {
                    event.consume();
                }
