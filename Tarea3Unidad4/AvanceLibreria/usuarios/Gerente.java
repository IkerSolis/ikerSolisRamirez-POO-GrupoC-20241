...
import libreria.utils.EmpleadoUtils;
...
public class Gerente extends Usuario implements EmpleadoUtils {
    ...
    public Gerente(String nombre, String apellido, String fechaNacimiento ,String telefono, double sueldo, String INE,  String nombreUsuario, String contrasena) {
        super(nombre, apellido, telefono, fechaNacimiento,Rol.GERENTE, nombreUsuario, contrasena);
        this.sueldo = sueldo;
        this.INE = INE;
    ...
    public void checarEntrada(){
        System.out.println("CHECHAR ENTRADA POR HUELLA");
    }

    @Override
    public void checarSalida() {
        System.out.println("CHECHAR SALIDA POR HUELLA");
    }
    ...
    public static void registrarGerente() {
        ...
        Gerente gerente = new Gerente(nombre, apellido, fechaNacimiento,telefono, sueldo, ine, nombreUsuario, contrasena);
